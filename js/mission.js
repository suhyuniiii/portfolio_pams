...
let posLeft = 20;
    ...
    //         if(e.wheelDelta < 0)
    //         {
    //             //scrollMove.style.left += sctop/5 + "px";
    //             scrollMove.style.marginLeft = sctop/5 + "px";
    //             scrollStretch.style.width = originalwidth + (sctop/3)/100 + "%";
    //             //scrollStretch.style.width += (sctop/3)/100 + "%";
    //         }
